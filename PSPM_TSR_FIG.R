...
segments(min(S4B_TM_BPE[,6]), max(log10(S4B_TM_LP[,1])), min(S4B_TM_BPE[,6]), log10(1E-3), lwd=2, lty=1, col="#d8b365")
...
Contrib.perc3 <- function(x, y, z){x+y+z}
...
par(tcl = 0.4)
par(mgp = c(2, 0.6, 0))
### Row 1: Consumer-Resource state ====
## TSR(Lmat) alone ====
par(mfg=c(1,1), mar = c(.5, 1, .5, .25))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=seq(0,30,by=5), label=F, las=2);
axis(2, at=seq(0,5)*20, label=T, las=2);
axis(4, at=seq(0,5)*20, label=F, las=2);

lines(S5B_T_CR_II[,1], Perc(S5B_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5B_T_CR_II[,1], Contrib.perc( Perc(S5B_T_CR_II, 7), Perc(S5B_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5B_T_CR_II[,1], Contrib.perc3( Perc(S5B_T_CR_II, 7), Perc(S5B_T_CR_II, 8), Perc(S5B_T_CR_II, 9)), lwd=2, col="black" )

## TPC + TSR(Lmat) ====
par(mfg=c(1,2), mar = c(.5, .25, .5, .75))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=seq(0,30,by=5), label=F, las=2);
axis(2, at=seq(0,5)*20, label=F, las=2);
axis(4, at=seq(0,5)*20, label=F, las=2);

lines(S5H_T_CR_II[,1], Perc(S5H_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5H_T_CR_II[,1], Contrib.perc( Perc(S5H_T_CR_II, 7), Perc(S5H_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5H_T_CR_II[,1], Contrib.perc3( Perc(S5H_T_CR_II, 7), Perc(S5H_T_CR_II, 8), Perc(S5H_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5H_T_CR_II[,1]), 0, min(S5H_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5H_T_CR_II[,1]), 0, max(S5H_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
lines(S5C_T_CR_II[,1], Perc(S5C_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5C_T_CR_II[,1], Contrib.perc( Perc(S5C_T_CR_II, 7), Perc(S5C_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5C_T_CR_II[,1], Contrib.perc3( Perc(S5C_T_CR_II, 7), Perc(S5C_T_CR_II, 8), Perc(S5C_T_CR_II, 9)), lwd=2, col="black" )
...
lines(S5I_T_CR_II[,1], Perc(S5I_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5I_T_CR_II[,1], Contrib.perc( Perc(S5I_T_CR_II, 7), Perc(S5I_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5I_T_CR_II[,1], Contrib.perc3( Perc(S5I_T_CR_II, 7), Perc(S5I_T_CR_II, 8), Perc(S5I_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5I_T_CR_II[,1]), 0, min(S5I_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5I_T_CR_II[,1]), 0, max(S5I_T_CR_II[,1]) , 100, lwd=2, lty=3)
## TSR(Lmat+Linf) ====
par(mfg=c(1,5), mar = c(.5, .75, .5, .25))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=seq(0,30,by=5), label=F, las=2);
...
lines(S5D_T_CR_II[,1], Perc(S5D_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5D_T_CR_II[,1], Contrib.perc( Perc(S5D_T_CR_II, 7), Perc(S5D_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5D_T_CR_II[,1], Contrib.perc3( Perc(S5D_T_CR_II, 7), Perc(S5D_T_CR_II, 8), Perc(S5D_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5D_T_CR_II[,1]), 0, min(S5D_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5D_T_CR_II[,1]), 0, max(S5D_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
axis(1, at=seq(0,30,by=5), label=F, las=2);
axis(2, at=seq(0,5)*20, label=F, las=2);
axis(4, at=seq(0,5)*20, label=T, las=2, cex.axis=1.1)

lines(S5J_T_CR_II[,1], Perc(S5J_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5J_T_CR_II[,1], Contrib.perc( Perc(S5J_T_CR_II, 7), Perc(S5J_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5J_T_CR_II[,1], Contrib.perc3( Perc(S5J_T_CR_II, 7), Perc(S5J_T_CR_II, 8), Perc(S5J_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5J_T_CR_II[,1]), 0, min(S5J_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5J_T_CR_II[,1]), 0, max(S5J_T_CR_II[,1]) , 100, lwd=2, lty=3)

### Row 2: Consumer-Resource state +TSR(Lv) ====
## TSR(Lv+Lmat) ====
par(mfg=c(2,1), mar = c(.5, 1, .5, .25))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=seq(0,30,by=5), label=F, las=2);
...
lines(S5E_T_CR_II[,1], Perc(S5E_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5E_T_CR_II[,1], Contrib.perc( Perc(S5E_T_CR_II, 7), Perc(S5E_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5E_T_CR_II[,1], Contrib.perc3( Perc(S5E_T_CR_II, 7), Perc(S5E_T_CR_II, 8), Perc(S5E_T_CR_II, 9)), lwd=2, col="black" )
...
lines(S5K_T_CR_II[,1], Perc(S5K_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5K_T_CR_II[,1], Contrib.perc( Perc(S5K_T_CR_II, 7), Perc(S5K_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5K_T_CR_II[,1], Contrib.perc3( Perc(S5K_T_CR_II, 7), Perc(S5K_T_CR_II, 8), Perc(S5K_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5K_T_CR_II[,1]), 0, min(S5K_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5K_T_CR_II[,1]), 0, max(S5K_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
lines(S5F_T_CR_II[,1], Perc(S5F_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5F_T_CR_II[,1], Contrib.perc( Perc(S5F_T_CR_II, 7), Perc(S5F_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5F_T_CR_II[,1], Contrib.perc3( Perc(S5F_T_CR_II, 7), Perc(S5F_T_CR_II, 8), Perc(S5F_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5F_T_CR_II[,1]), 0, min(S5F_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5F_T_CR_II[,1]), 0, max(S5F_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
lines(S5L_T_CR_II[,1], Perc(S5L_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5L_T_CR_II[,1], Contrib.perc( Perc(S5L_T_CR_II, 7), Perc(S5L_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5L_T_CR_II[,1], Contrib.perc3( Perc(S5L_T_CR_II, 7), Perc(S5L_T_CR_II, 8), Perc(S5L_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5L_T_CR_II[,1]), 0, min(S5L_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5L_T_CR_II[,1]), 0, max(S5L_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
lines(S5G_T_CR_II[,1], Perc(S5G_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5G_T_CR_II[,1], Contrib.perc( Perc(S5G_T_CR_II, 7), Perc(S5G_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5G_T_CR_II[,1], Contrib.perc3( Perc(S5G_T_CR_II, 7), Perc(S5G_T_CR_II, 8), Perc(S5G_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5G_T_CR_II[,1]), 0, min(S5G_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5G_T_CR_II[,1]), 0, max(S5G_T_CR_II[,1]) , 100, lwd=2, lty=3)
...
axis(1, at=seq(0,30,by=5), label=F, las=2);
axis(2, at=seq(0,5)*20, label=F, las=2);
axis(4, at=seq(0,5)*20, label=T, las=2);

lines(S5M_T_CR_II[,1], Perc(S5M_T_CR_II, 7), lwd=2, col="lightgrey" )
lines(S5M_T_CR_II[,1], Contrib.perc( Perc(S5M_T_CR_II, 7), Perc(S5M_T_CR_II, 8)), lwd=2, col="darkgrey" )
lines(S5M_T_CR_II[,1], Contrib.perc3( Perc(S5M_T_CR_II, 7), Perc(S5M_T_CR_II, 8), Perc(S5M_T_CR_II, 9)), lwd=2, col="black" )
segments(min(S5M_T_CR_II[,1]), 0, min(S5M_T_CR_II[,1]) , 100, lwd=2, lty=3)
segments(max(S5M_T_CR_II[,1]), 0, max(S5M_T_CR_II[,1]) , 100, lwd=2, lty=3)

### Row 3: Predator-Consumer-Resource state ====
## TSR(Lmat) alone ====
par(mfg=c(3,1), mar = c(.5, 1, .5, .25))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=seq(0,30,by=5), label=F, las=2);
...
lines(S5B_T_PCR_IIa[44:62,1], Perc(S5B_T_PCR_IIa[44:62,], 7), lwd=2, col="lightgrey" )
lines(S5B_T_PCR_IIa[44:62,1], Contrib.perc( Perc(S5B_T_PCR_IIa[44:62,], 7), Perc(S5B_T_PCR_IIa[44:62,], 8)), lwd=2, col="darkgrey" )
lines(S5B_T_PCR_IIa[44:62,1], Contrib.perc3( Perc(S5B_T_PCR_IIa[44:62,], 7), Perc(S5B_T_PCR_IIa[44:62,], 8), Perc(S5B_T_PCR_IIa[44:62,], 9)), lwd=2, col="black" )
segments(min(S5B_T_PCR_IIa[,1]), 0, min(S5B_T_PCR_IIa[,1]) , 100, lwd=2, lty=3, col=rgb(0.9,0,0) )
...
lines(S5H_T_PCR_IIa[,1], Perc(S5H_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5H_T_PCR_IIa[,1], Contrib.perc( Perc(S5H_T_PCR_IIa, 7), Perc(S5H_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5H_T_PCR_IIa[,1], Contrib.perc3( Perc(S5H_T_PCR_IIa, 7), Perc(S5H_T_PCR_IIa, 8), Perc(S5H_T_PCR_IIa, 9)), lwd=2, col="black" )
segments(min(S5H_T_PCR_IIa[,1]), 0, min(S5H_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
segments(max(S5H_T_PCR_IIa[,1]), 0, max(S5H_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
...
lines(S5C_T_PCR_IIa[48:85,1], Perc(S5C_T_PCR_IIa[48:85,], 7), lwd=2, col="lightgrey" )
lines(S5C_T_PCR_IIa[48:85,1], Contrib.perc( Perc(S5C_T_PCR_IIa[48:85,], 7), Perc(S5C_T_PCR_IIa[48:85,], 8)), lwd=2, col="darkgrey" )
lines(S5C_T_PCR_IIa[48:85,1], Contrib.perc3( Perc(S5C_T_PCR_IIa[48:85,], 7), Perc(S5C_T_PCR_IIa[48:85,], 8), Perc(S5C_T_PCR_IIa[48:85,], 9)), lwd=2, col="black" )
segments(max(S5C_T_PCR_IIa[,1]), 0, max(S5C_T_PCR_IIa[,1]) , 100, lwd=2, lty=3, col=rgb(0.9,0,0))
...
lines(S5I_T_PCR_IIa[,1], Perc(S5I_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5I_T_PCR_IIa[,1], Contrib.perc( Perc(S5I_T_PCR_IIa, 7), Perc(S5I_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5I_T_PCR_IIa[,1], Contrib.perc3( Perc(S5I_T_PCR_IIa, 7), Perc(S5I_T_PCR_IIa, 8), Perc(S5I_T_PCR_IIa, 9)), lwd=2, col="black" )
segments(min(S5I_T_PCR_IIa[,1]), 0, min(S5I_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
segments(max(S5I_T_PCR_IIa[,1]), 0, max(S5I_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
...
lines(S5D_T_PCR_IIa[32:45,1], Perc(S5D_T_PCR_IIa[32:45,], 7), lwd=2, col="lightgrey" )
lines(S5D_T_PCR_IIa[32:45,1], Contrib.perc( Perc(S5D_T_PCR_IIa[32:45,], 7), Perc(S5D_T_PCR_IIa[32:45,], 8)), lwd=2, col="darkgrey" )
lines(S5D_T_PCR_IIa[32:45,1], Contrib.perc3( Perc(S5D_T_PCR_IIa[32:45,], 7), Perc(S5D_T_PCR_IIa[32:45,], 8), Perc(S5D_T_PCR_IIa[32:45,], 9)), lwd=2, col="black" )
segments(min(S5D_T_PCR_IIa[,1]), 0, min(S5D_T_PCR_IIa[,1]) , 100, lwd=2, lty=3, col="red")
...
lines(S5J_T_PCR_IIa[,1], Perc(S5J_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5J_T_PCR_IIa[,1], Contrib.perc( Perc(S5J_T_PCR_IIa, 7), Perc(S5J_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5J_T_PCR_IIa[,1], Contrib.perc3( Perc(S5J_T_PCR_IIa, 7), Perc(S5J_T_PCR_IIa, 8), Perc(S5J_T_PCR_IIa, 9)), lwd=2, col="black" )
segments(min(S5J_T_PCR_IIa[,1]), 0, min(S5J_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
segments(max(S5J_T_PCR_IIa[,1]), 0, max(S5J_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)

### Row 4: Predator-Consumer-Resource state +TSR(Lv) ====
## TSR(Lv+Lmat) ====
par(mfg=c(4,1), mar = c(1, 1, .5, .25))
plot(1, 1, type="l", xlim=c(1, 30), xlab="", xaxt="n", xaxs="i", ylim=c(0, 105), ylab="", yaxt="n", yaxs="i");
axis(1, at=c(5,15,25), label=T, las=1, cex.axis=1.1);
...
lines(S5E_T_PCR_IIb[,1], Perc(S5E_T_PCR_IIb, 7), lwd=2, col="lightgrey" )
lines(S5E_T_PCR_IIb[,1], Contrib.perc( Perc(S5E_T_PCR_IIb, 7), Perc(S5E_T_PCR_IIb, 8)), lwd=2, col="darkgrey" )
lines(S5E_T_PCR_IIb[,1], Contrib.perc3( Perc(S5E_T_PCR_IIb, 7), Perc(S5E_T_PCR_IIb, 8), Perc(S5E_T_PCR_IIb, 9)), lwd=2, col="black" )
...
lines(S5K_T_PCR_IIa[,1], Perc(S5K_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5K_T_PCR_IIa[,1], Contrib.perc( Perc(S5K_T_PCR_IIa, 7), Perc(S5K_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5K_T_PCR_IIa[,1], Contrib.perc3( Perc(S5K_T_PCR_IIa, 7), Perc(S5K_T_PCR_IIa, 8), Perc(S5K_T_PCR_IIa, 9)), lwd=2, col="black" )
segments(min(S5K_T_PCR_IIa[,1]), 0, min(S5K_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
segments(max(S5K_T_PCR_IIa[,1]), 0, max(S5K_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
...
lines(S5F_T_PCR_II[264:409,1], Perc(S5F_T_PCR_II[264:409,], 7), lwd=2, col="lightgrey" )
lines(S5F_T_PCR_II[264:409,1], Contrib.perc( Perc(S5F_T_PCR_II[264:409,], 7), Perc(S5F_T_PCR_II[264:409,], 8)), lwd=2, col="darkgrey" )
lines(S5F_T_PCR_II[264:409,1], Contrib.perc3( Perc(S5F_T_PCR_II[264:409,], 7), Perc(S5F_T_PCR_II[264:409,], 8), Perc(S5F_T_PCR_II[264:409,], 9)), lwd=2, col="black" )
segments(max(S5F_T_PCR_II[,1]), 0, max(S5F_T_PCR_II[,1]) , 100, lwd=2, lty=3, col=rgb(0.6,0,0))
...
lines(S5L_T_PCR_IIa[,1], Perc(S5L_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5L_T_PCR_IIa[,1], Contrib.perc( Perc(S5L_T_PCR_IIa, 7), Perc(S5L_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5L_T_PCR_IIa[,1], Contrib.perc3( Perc(S5L_T_PCR_IIa, 7), Perc(S5L_T_PCR_IIa, 8), Perc(S5L_T_PCR_IIa, 9)), lwd=2, col="black" )
segments(min(S5L_T_PCR_IIa[,1]), 0, min(S5L_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
segments(max(S5L_T_PCR_IIa[,1]), 0, max(S5L_T_PCR_IIa[,1]) , 100, lwd=2, lty=3)
...
lines(S5G_T_PCR_IIa[51:82,1], Perc(S5G_T_PCR_IIa[51:82,], 7), lwd=2, col="lightgrey" )
lines(S5G_T_PCR_IIa[51:82,1], Contrib.perc( Perc(S5G_T_PCR_IIa[51:82,], 7), Perc(S5G_T_PCR_IIa[51:82,], 8)), lwd=2, col="darkgrey" )
lines(S5G_T_PCR_IIa[51:82,1], Contrib.perc3( Perc(S5G_T_PCR_IIa[51:82,], 7), Perc(S5G_T_PCR_IIa[51:82,], 8), Perc(S5G_T_PCR_IIa[51:82,], 9)), lwd=2, col="black" )
segments(max(S5G_T_PCR_IIa[,1]), 0, max(S5G_T_PCR_IIa[,1]) , 100, lwd=2, lty=3, col=rgb(.6,0,0))
...
lines(S5M_T_PCR_IIa[,1], Perc(S5M_T_PCR_IIa, 7), lwd=2, col="lightgrey" )
lines(S5M_T_PCR_IIa[,1], Contrib.perc( Perc(S5M_T_PCR_IIa, 7), Perc(S5M_T_PCR_IIa, 8)), lwd=2, col="darkgrey" )
lines(S5M_T_PCR_IIa[,1], Contrib.perc3( Perc(S5M_T_PCR_IIa, 7), Perc(S5M_T_PCR_IIa, 8), Perc(S5M_T_PCR_IIa, 9)), lwd=2, col="black" )
